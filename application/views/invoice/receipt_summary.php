    ...
    <br/>
          <div class="row">
            <table class="table detail" style="border-collapse: separate;line-height:20px;border: 1px solid black">
                ...
                <tbody>
                  <?php $last_page = FALSE; ?>
                  <?php if(sizeof($query_transaction_detail) == 0){ $last_page = TRUE; } ?>
                  <?php $index = 1; if(!empty($start_row)){ $index = $start_row+1; }
                        ...
                        <tr>
                          <td class="col-xs-8 text-left" colspan= "3" style="border-bottom:0px" ><p>
                            ...
                            <?php } else if($receipt_no){ ?>
                              โปรดชำระเงินด้วยเช็คคร่อม หรือ สั่งจ่ายในนามบัญชี ' บริษัท วีเทรนด์ อินเตอร์เทรด จำกัด '</br>
